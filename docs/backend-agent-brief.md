...
- El frontend ahora consume:
  ...
  - `POST http://localhost:4000/api/reviews` al crear una reseña (payload: `{ gameId, gameName, review, rating, cover? }`).
...
- [ ] Extender pruebas automatizadas para la nueva colección.
